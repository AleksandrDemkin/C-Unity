...
namespace RollABall
{
    public class Reference
    {
        ...
        private Button _restarLeveltButton;
        
        public PlayerBase PlayerBall
        {
            get
            {
                if (_playerBall == null)
        ...
        public Button RestarLeveltButton
        {
            get
            {
                if (_restarLeveltButton == null)
                {
                    var gameObject = Resources.Load<Button>("UI/RestarLeveltButton");
                    _restarLeveltButton = Object.Instantiate(gameObject,
                        Canvas.transform);
                }
                return _restarLeveltButton;
            }
        }
    }
}
